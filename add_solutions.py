...
def create_and_merge():
    ...
    pdf_path = os.path.abspath("temp_page.pdf")
...
<body>
    <h2>ĐỀ XUẤT GIẢI PHÁP CHO CÁC THÁCH THỨC ĐẠO ĐỨC</h2>
    ...
    insert_idx = len(doc_main) - 1 # Insert before the last page
    doc_main.insert_pdf(doc_temp, from_page=0, to_page=0, start_at=insert_idx)
    
    doc_main.save("reports/Bai6_updated.pdf")
    doc_main.close()
    doc_temp.close()
    print("SUCCESS")
